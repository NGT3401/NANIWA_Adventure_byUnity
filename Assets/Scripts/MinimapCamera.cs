...
{
    [ExecuteInEditMode]
    public class MinimapCamera : PivotBasedCameraRig
    {
        [SerializeField]
        private float m_TargetDistanceY = 20;
        [SerializeField]
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + new Vector3(0, m_TargetDistanceY, 0), deltaTime * m_MoveSpeed);
